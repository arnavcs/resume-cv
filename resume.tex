...
\begin{resumeList}
    \item Received the Ronald G. Dunkley National Scholarship and the President's Entrance Scholarship of Distinction.
    \item Core average of 97\% with all advanced level courses.
\end{resumeList}
\end{resumeItem}
